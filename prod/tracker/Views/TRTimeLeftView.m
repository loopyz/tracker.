...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // Initialization code
        self.backgroundColor = [TRColors daysLeftColor];
        [self setupClockIcon];
...
- (void)setupLabelAttributes
{
    ...
    currentDayLabel.textColor = [TRColors grayFontColor];
    currentDayLabel.font = [TRFonts currentDayFont];
    ...
    daysLeftTillEndLabel.textColor = [TRColors grayFontColor];
    daysLeftTillEndLabel.font = [TRFonts estimatedDaysLeftFont];
    ...
    daysUntilPeriodLabel.textColor = [TRColors grayFontColor];
    daysUntilPeriodLabel.font = [TRFonts daysUntilPeriodFont];
    ...
    untilPeriod.textColor = [TRColors grayFontColor];
    untilPeriod.font = [TRFonts daysUntilPeriodFont];
...
- (void)setupDaysLeftTillEnd:(NSUInteger)daysLeft
{
    ...
    if (daysLeft > kTRMaxPeriodDuration) {
